...
import cv from "../../assets/Umarov-Dilshod.pdf";
...
const Header = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-[#14011b]">
      ...
      <div className="relative z-10 w-full max-w-[1370px] mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-[260px]">
        <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
          ...
          <div className="mt-10 flex  ml-[-280px]">
            <a
              href={cv}
